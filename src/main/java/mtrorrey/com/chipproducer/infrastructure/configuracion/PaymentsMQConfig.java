...
@Configuration
public class PaymentsMQConfig {
  @Value("${spring.rabbitmq.queue_payments.name}")
  private String queue;

  @Value("${spring.rabbitmq.exchange.name}")
  private String exchange;

  @Value("${spring.rabbitmq.queue_payments.routing.key}")
  ...
  @Bean
  public TopicExchange exchangePayments(){
    return new TopicExchange(exchange);
  }


  @Bean
  public Binding bindingPayments(){
    return BindingBuilder.bind(queuePayments())
      .to(exchangePayments())
      .with(routingKey);
  }
}
